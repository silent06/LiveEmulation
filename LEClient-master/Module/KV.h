...
public:
	...
	static bool bIsDevkit;
	static bool bCRL;
	static bool bFCRT;

	static BYTE bStockMacAddress[0x6];
	static BYTE bMacAddress[0x6];
	static BYTE bCpuKey[0x10];
	static BYTE bKvCpuKey[0x10];
	static BYTE bHmacKVHash[0x14];

	static DWORD dwUpdateSequence;

	static KEY_VAULT sKeyVault;
